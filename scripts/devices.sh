...
nr_panel_for_board() {
    case "$1" in
        ...
        # iPad A12 / A12X / A13
        j210ap|j211ap) echo "1536 2048" ;;  # iPad mini 5
        j217ap|j218ap) echo "1668 2224" ;;  # iPad Air 3
        j171ap|j171aap|j172aap|j181ap|j182ap) echo "1620 2160" ;; # iPad 8/9
        j317ap|j317xap|j318ap|j318xap|j417ap|j418ap) echo "1668 2388" ;; # Pro 11"
        j320ap|j320xap|j321ap|j321xap|j420ap|j421ap) echo "2048 2732" ;; # Pro 12.9"
        *)
